import { getSingleData } from "@/app/utils/getSIngleData";
import formatDate from "@/app/utils/formatDate";

export default async function page({ params }) {
  const singleNewsData = getSingleData("news", params.id);

  const [singleNews] = await Promise.all([singleNewsData]);

  return (
    <main class="main main--newsDetail">
      <div class="main__inner">
        <div class="modSectionMain modSectionMain--page modSectionMain--news">
          <div class="modSectionMain__contentWrapper modSectionMain__contentWrapper--page">
            <hgroup class="modSectionMain__content modSectionMain__content--page">
              <p class="modHeading modHeading--hero modHeading--animated">
                <span>N</span>
                <span>e</span>
                <span>w</span>
                <span>s</span>
              </p>
              <h1 class="modHeadingSub modHeadingSub--fs22 modHeadingSub--mt">
                お知らせ
              </h1>
            </hgroup>
            <div class="modSectionMain__cartoon modSectionMain__cartoon--page modSectionMain__cartoon--news brushAnimate">
              <div class="modSectionMain__cartoon__movie">
                <span class="line">
        ...
        <section class="main__section main__section--newsDetail">
          <div class="main__section__inner">
            <date>{formatDate(singleNews.date)}</date>
            <h2>{singleNews.title.rendered}</h2>
            <div class="article">
              <p>
                記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります{" "}
                <br />
                記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります
                <br />
                記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります記事内容が入ります
              </p>
              <h3>h3テキストが入ります</h3>
              <h4>h4テキストが入ります</h4>
              <p>
              ...
              <ul>
                <li>
                  業種問わず営業職経験3年以上の方、歓迎
                  <br />
                  営業未経験の方もご応募いただけます。意欲を一番に重視しています
                </li>
                <li>
                  素直に相手の話を聴ける方（感情的にならずに、相手の立場にも立って観ることができるか）
                </li>
                <li>結果が出るまで、前向きに粘り強く継続する方</li>
              </ul>
              <ol>
                <li>
                  業種問わず営業職経験3年以上の方、歓迎 <br />
                  営業未経験の方もご応募いただけます。意欲を一番に重視しています
                </li>
                <li>
                  素直に相手の話を聴ける方（感情的にならずに、相手の立場にも立って観ることができるか）
              ...
              <p class="article__bold">
                太字文章が入ります文章が入ります、文章が入ります文章が入ります文章が入ります文章が入ります。
              </p>
              <p class="article__linethrough">
                打ち消し線の文章が入ります。打ち消し線の文章が入ります。打ち消し線の文章が入ります。
              </p>
              ...
              <div class="article__sub">
                ...
                <a href="#">
                  引用元 <span>URL</span> が入ります
                </a>
              </div>
              <div class="article__columns">
                <figure class="article__columns__item">
                  <img
                    src="https://placehold.jp/470x300.png"
                    width="470"
                    height="300"
                    loading="lazy"
                    alt=""
                ...
                <div class="article__columns__item">
                  <h3>h3テキストが入ります</h3>
                  <p>
              ...
              <div class="article__columns article__columns--reverse">
                <figure class="article__columns__item">
                  <img
                    src="https://placehold.jp/470x300.png"
                    width="470"
              ...
              <div class="article__figure">
                <figure>
                  <img
                    src="https://placehold.jp/940x300.png"
                    width="940"
                    height="300"
                    loading="lazy"
                    alt=""
              ...
              <div class="article__figure article__figure--multiColumns">
                <figure>
                  <img
                    src="https://placehold.jp/460x293.png"
                    width="460"
                    height="293"
                    loading="lazy"
                    alt=""
              ...
              <div class="article__figure article__figure--multiColumns">
                <figure>
                  <img
                    src="https://placehold.jp/300x191.png"
                    width="300"
                    height="191"
                    loading="lazy"
                    alt=""
